<div>
    @push('link')
        <link href="/admin-asset/src/assets/css/dark/apps/invoice-preview.css" rel="stylesheet" type="text/css" />
    @endpush
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 text-sm-end">
                                                        <p class="inv-list-number mt-sm-3 pb-sm-2 mt-4" wire:ignore><span
                                                                ...
                                                                class="inv-number">{{ $orderDetails->order_number }}</span></p>
                                                        ...
                                                        <p class="inv-due-date"><span class="inv-title">تاریخ آخرین تغییر :
                                                            </span> <span class="inv-date">{{ jalali( $orderDetails->updated_at)->format('d M Y | h:i') }}</span></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="inv--detail-section inv--customer-detail-section">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4">
                                                        ...
                                                        <p class="inv-email-address text-white badge badge-{{  $orderDetails->statusPaymentColor }}">
                                                            وضعیت پرداخت:
                                                        ...
                                                        <tbody>
                                                            @foreach ($orderDetails->orderItems as $item)
                                                                <tr>
                                                                    <td>{{ $loop->index + 1 }}</td>
                                                                    <td>
                                                                        <img class="rounded-3" src="/products/{{ $item->product->id }}/small/{{ @$item->product->coverImage->path }}"
                                                                            alt="">
                                                                    </td>
                                    ...
                                    <div class="col-xl-12 col-md-3 col-sm-6">
                                        <select class="form-control bg-{{ @$statusColor }}"
                                            ...
                                            <option value="processing"
                                                {{ $orderDetails->status == 'processing' ? 'selected' : '' }}>processing</option>
                                            <option value="completed" {{ $orderDetails->status == 'completed' ? 'selected' : '' }}>
                                                completed</option>
                                            <option value="canceled" {{ $orderDetails->status == 'canceled' ? 'selected' : '' }}>
                                                canceled</option>
                                        </select>
                                    </div>
