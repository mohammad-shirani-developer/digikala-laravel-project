    ...
    <div class="statbox widget box box-shadow">
        <div class="widget-header">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex">
                    <h4>لیست کاربران</h4>
                    <input type="text" wire:model.live.debounce.300ms="search" placeholder="جستجو"
                        class="form-control">
                </div>
            </div>
        </div>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th width="50px" scope="col">نام</th>
                            <th width="150px" scope="col">شماره تلفن</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.order.index') }}/?user={{ $item->id }}"
                                        ...
                                        title="" data-bs-original-title="جزییات">
                                        سفارشات
                                        ({{ $item->orders_count }})
