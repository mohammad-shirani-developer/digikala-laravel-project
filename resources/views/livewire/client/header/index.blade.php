        ...
        <div class="row py-4 mx-lg-4">
            <div class="col-12 col-lg-8 d-flex align-items-center column-gap-2">
                ...
                <div class="bg-secondary-subtle py-1 px-4 searchInput rounded searchInput d-flex align-items-center">
                    ...
                    <!-- mobile search -->
                    <input type="text" style="width: 57px" class="d-block d-lg-none bg-transparent border-0 py-2"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="clean">
                            <!-- ads banner -->
                            <a href="#">
                                <img src="/client/assets/header/headerAds.webp" alt="ads"
                            ...
                            <div class="menu-list">
                                <ul>
                                    ...
                                    <li data-target="cat-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-scooter" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
                                    ...
                                    <li data-target="cat-5">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-person-standing-dress"
                                            viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <li data-target="cat-8">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-bucket" viewBox="0 0 16 16">
                                            <path
