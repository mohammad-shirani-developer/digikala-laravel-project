    <div class="col col-lg-4">
        ...
        <div class="d-none d-lg-flex row flex-row-reverse flex-lg-row align-items-start">
            <div class="col col-lg-1 d-flex flex-lg-column gap-3">
                ...
                <button class="bg-transparent border-0">
                    <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        class="bi bi-vr" viewBox="0 0 16 16">
                        <path
            ...
            <div class="col col-lg-11">
                <img src="/products/{{ $productId }}/large/{{ $coverImage->path }}" alt="nothingPhone"
                    class="w-100" />
            </div>
        </div>
        <!-- == desktop gallery == -->
        <div>
            ...
            <div class="d-none d-lg-flex align-items-center gap-2 mx-3">
                @foreach ($images as $item)
                    <button type="button" class="border rounded-2 p-0 m-0 bg-transparent opacity-50"
                                ...
                                <div class="carousel-inner w-100">
                                    @foreach ($images as $item)
                                        <div class="carousel-item {{ $loop->first ? 'active' : '' }} ">
                                            <img src="/products/{{ $productId }}/large/{{ $item->path }}"
                                                class="d-block mx-auto my-5 w-50 h-100" alt="nothingPhone" />
                                        </div>
                                    @endforeach
