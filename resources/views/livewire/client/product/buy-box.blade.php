<div class="col p-0 p-lg-auto col-lg-3 mt-5 mt-lg-0 seller">
    <div class="bg-light border rounded-4 p-3 p-lg-3 mb-3">
        ...
        <div class="d-none d-lg-flex justify-content-between align-items-center">
            ...
            <div>
                <div class="d-flex gap-3">
                    <p class="text-secondary fs-8"><s>{{ number_format($finalPrice) }}</s></p>
                    <span class="bg-danger text-white fs-8 px-2 py-1 rounded-5">{{ $discount }}%</span>
                </div>
                <p class="fw-bold mt-3">{{ number_format($price) }} <span class="fs-8">تومان</span></p>
            </div>
        </div>
        ...
        @if (\Illuminate\Support\Facades\Auth::check())
            @if (!$inCart)
                <button wire:click='addToCart'
                    ...
                    <span wire:loading="addToCart" class="loader"></span>
                </button>
            @else
                <button
        ...
        <button class="w-100 border-0 bg-transparent my-2 d-flex justify-content-between" data-bs-toggle="modal"
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <!-- Tooltip -->
            <button type="button" class="bg-transparent border-0 mt-1" data-bs-toggle="tooltip"
    ...
    <a href="#"
        ...
        <p class="text-secondary fs-8">
            <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-secondary ms-1">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
            </svg>
