<div class="modal fade" id="commentModal" wire:ignore.self tabindex="-1"
            ...
            <form wire:submit="submitReview(Object.fromEntries(new FormData($event.target)))">
                <div class="modal-body">
                    <div class="d-flex align-items-start justify-content-center">
                        <div>
                            <img src="/client/assets/Product/nothingPhone/1.webp" alt="phone"
                                width="70" />
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label fs-8">عنوان نظر</label>
                    ...
                    <div
                        ...
                        <button type="button" wire:click='addItem("positive")' id="addButtonPositive"
                            class="bg-transparent border-0 fs-3 m-2">+</button>
                    </div>
                    @error('positiveInput')
                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                    @enderror
                    <ul id="positiveList" class="list-group p-0">
                        ...
                        <li
                            class="list-group-item border-0 d-flex justify-content-between align-items-center my-2">
                    ...
                    <div class="alert alert-success mt-2">
                        دیدگاه شما با موفقیت ثبت شد.بعد از تایید مدیریت نمایش داده میشود.
                    </div>
                    @endif
