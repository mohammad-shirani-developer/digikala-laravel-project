<div>
    <section
        ...
        <!-- More -->
        <div class="d-flex flex-column align-items-center justify-content-center gap-2">
            <a href="#" class="bg-secondary-subtle text-black-50 rounded-5 p-3" data-bs-toggle="modal"
                data-bs-target="#exampleModal">
                <svg width="23" height="23" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
