    ...
    <section class="container my-4 bg-secondary-subtle rounded-4 superMarketSuggest overflow-hidden">
        <a href="#" class="row align-items-center p-4">
            <div class="col-12 col-lg-5 d-flex flex-wrap align-items-center gap-3">
                ...
                <p class="fs-7 text-white bg-success px-3 py-2 rounded-5 mb-3 mx-auto mb-lg-0 mx-lg-0">تا 59% تخفیف
                </p>
            </div>
            <div class="col-12 col-lg-7 d-flex align-items-center justify-content-end gap-3">
                ...
                <div class="fs-8 fw-medium text-success bg-white px-4 py-3 rounded-5">
                    ...
                    <span class="ms-lg-2">
                        <svg width="19" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
