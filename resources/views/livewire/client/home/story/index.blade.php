        ...
        <div class="d-flex py-2 py-lg-5 py-md-3 justify-content-center align-items-center">
            <div class="swiper myStorySwiper px-0">
                <div class="swiper-wrapper">
                    <div class="swiper-slide d-flex flex-column justify-content-center" data-bs-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content bg-transparent border-0">
                <div class="modal-header border-bottom-0">
                    <button type="button" class="btn-close bg-white rounded-4" data-bs-dismiss="modal"
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide">
                        ...
                        <div class="carousel-inner pb-5">
                            <div class="carousel-item active">
                                <img src="/client/assets/story/best price.jpeg" class="d-block w-25 mx-auto"
                                    alt="..." />
                            </div>
                            <div class="carousel-item">
                                <img src="/client/assets/story/cover.jpeg" class="d-block w-25 mx-auto"
                                    alt="..." />
                            </div>
                            <div class="carousel-item">
                                <img src="/client/assets/story/perfume.jpeg" class="d-block w-25 mx-auto"
                                    alt="..." />
                            </div>
                        </div>
