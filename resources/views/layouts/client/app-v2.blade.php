...
<body>
            ...
            <nav class="navbar mt-4 d-flex align-items-center d-sm-none d-md-none">
                <div class="w-75">
                    <ul class="navbar__item-container d-flex align-items-center">
                        ...
                        <li class="navbar__item">
                            <a href="#" class="ml-4"><i class="fa-light fa-gift-card ml-2"></i>
                                کارت هدیه
                            </a>
                        </li>
                        <li class="navbar__item">
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="row footer__block">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 footer-contact-us">
                    ...
                    <div class="footer-form">
                        ...
                        <div class="footer-form__container mt-3 d-flex justify-content-between align-items-center">
                            <input class="footer-form__email" type="text"
            ...
            <div class="footer-apps mt-5 mb-5 d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex mt-5 mb-5 footer-trust">
                ...
                <div class="d-flex mr-5 align-items-center footer-trust__left w-50 justify-content-end">
                    <a href="#" class="footer-trust__item"><img src="/client/assets-v2/images/rezi.webp"
                            alt="" class="footer-trust__img" /></a>
